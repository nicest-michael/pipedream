...
export default {
  ...
  description: "Check the processing status of a video and retrieve the final URL when ready. [See the documentation](https://dashboard.visibot.app/api-docs.openapi)",
  version: "0.0.1",
  type: "action",
  annotations: {
    readOnlyHint: true,
